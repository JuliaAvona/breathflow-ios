...
export const BADGE_DEFINITIONS = [
  ...
  {
    id: 'dedicated_breather',
    nameKey: 'badges.dedicated_breather.name',
    descriptionKey: 'badges.dedicated_breather.description',
    icon: 'heart-outline',
    category: 'sessions' as BadgeCategory,
    isPro: false,
  },
  ...
  {
    id: 'hour_power',
    nameKey: 'badges.hour_power.name',
  ...
  {
    id: 'deep_diver',
    nameKey: 'badges.deep_diver.name',
  ...
  {
    id: 'year_legend',
    nameKey: 'badges.year_legend.name',
