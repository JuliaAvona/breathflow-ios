export default {
  ...
  'onboarding.socialProof1': 'De încredere pentru atleți',
  'onboarding.socialProof2': 'Stanford-backed',
  'onboarding.socialProof3': 'Apple Health',
  'onboarding.commitTitle': 'Setați-vă obiectivul zilnic',
  'onboarding.commitSub': 'Obiceiurile mici zilnice creează schimbări durabile.',
  'onboarding.commitMinUnit': 'min / zi',
  'onboarding.commitHint_3': 'Chiar și o sesiune de 3 minute poate ajuta la calmarea sistemului nervos.',
  'onboarding.commitHint_5': 'Cercetările Stanford leagă respirația lentă de mai puțin stres și somn mai bun.',
  'onboarding.commitHint_10': 'Navy SEALs folosesc Box Breathing pentru a rămâne concentrați sub presiune.',
  'onboarding.commitHint_15': 'Dr. Andrew Huberman recomandă 15 min de lucru cu respirația zilnic.',
  'onboarding.buildingTitle': 'Construim planul tău...',
  'onboarding.buildingStep1': 'Analizarea obiectivului tău',
  'onboarding.buildingStep2': 'Selectarea tehnicilor',
  'onboarding.buildingStep3': 'Personalizarea programului tău',
  'onboarding.valueProgress': 'Urmărește progresul zilnic și seriile',
  'onboarding.valueBadges': 'Câștigă insigne pentru etape',
  'onboarding.valueHealth': 'Sincronizare cu Apple Health',
  'onboarding.valueTechniques': '10 tehnici susținute de știință',
  'onboarding.valueFree': 'Gratuit pentru totdeauna · Fără reclame · Fără trucuri',
  ...
  'paywall.feature1': 'Toate cele 10 tehnici de respirație',
  'paywall.feature2': 'Toate piesele muzicale',
  'paywall.feature3': 'Deblochează toate insignele',
  'paywall.feature4': 'Istoric complet și statistici',
  ...
  'paywall.unlockForever': 'Deblochează pentru totdeauna',
  'paywall.startAnnual': 'Începe planul anual',
  'paywall.startWeekly': 'Începe săptămânal',
