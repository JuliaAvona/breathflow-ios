export default {
  ...
  'onboarding.commitHint_10': 'Navy SEALs käyttää Box Breathingia pysyäkseen keskittyneenä paineen alla.',
  ...
  'onboarding.valueProgress': 'Seuraa päivittäistä edistymistä ja sarjoja',
  'onboarding.valueBadges': 'Ansaitse merkkejä virstanpylväistä',
