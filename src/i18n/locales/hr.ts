export default {
  ...
  'onboarding.socialProof1': 'Povjerenje sportaša',
  ...
  'onboarding.commitHint_3': 'Čak i 3-minutna sesija može pomoći u smirivanju živčanog sustava.',
  'onboarding.commitHint_5': 'Istraživanje Stanforda povezuje sporo disanje s manjim stresom i boljim snom.',
  'onboarding.commitHint_10': 'Navy SEALs koriste Box Breathing za fokus pod pritiskom.',
  'onboarding.commitHint_15': 'Dr. Andrew Huberman preporučuje 15 min dnevnog rada s dahom.',
  'onboarding.buildingTitle': 'Izrađujemo vaš plan...',
  'onboarding.buildingStep1': 'Analiziranje vašeg cilja',
  'onboarding.buildingStep2': 'Odabir tehnika',
  'onboarding.buildingStep3': 'Personaliziranje vašeg rasporeda',
  'onboarding.valueProgress': 'Pratite dnevni napredak i nizove',
  'onboarding.valueBadges': 'Zaradite značke za prekretnice',
  ...
  'paywall.feature3': 'Otključaj sve značke',
  ...
  'paywall.weekly': 'Tjedna',
  'paywall.lifetime': 'Doživotna',
  ...
  'paywall.unlockForever': 'Otključaj zauvijek',
  'paywall.startAnnual': 'Započni godišnji plan',
  'paywall.startWeekly': 'Započni tjedni',
