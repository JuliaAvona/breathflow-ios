export default {
  ...
  'onboarding.socialProof1': 'Zaufany przez sportowców',
  'onboarding.socialProof2': 'Stanford-backed',
  'onboarding.socialProof3': 'Apple Health',
  'onboarding.commitTitle': 'Ustaw swój dzienny cel',
  'onboarding.commitSub': 'Małe codzienne nawyki tworzą trwałą zmianę.',
  'onboarding.commitMinUnit': 'min / dzień',
  'onboarding.commitHint_3': 'Nawet 3-minutowa sesja może pomóc uspokoić układ nerwowy.',
  'onboarding.commitHint_5': 'Badania Stanfordu łączą wolne oddychanie z mniejszym stresem i lepszym snem.',
  'onboarding.commitHint_10': 'Navy SEALs używają Box Breathing, aby pozostać skupionym pod presją.',
  'onboarding.commitHint_15': 'Dr. Andrew Huberman zaleca 15 min codziennej pracy z oddechem dla trwałych efektów.',
  'onboarding.buildingTitle': 'Tworzymy Twój plan...',
  'onboarding.buildingStep1': 'Analizowanie Twojego celu',
  'onboarding.buildingStep2': 'Wybieranie technik',
  'onboarding.buildingStep3': 'Personalizacja Twojego harmonogramu',
  'onboarding.valueProgress': 'Śledź dzienny postęp i serie',
  'onboarding.valueBadges': 'Zdobywaj odznaki za kamienie milowe',
  'onboarding.valueHealth': 'Synchronizacja z Apple Health',
  'onboarding.valueTechniques': '10 naukowo popartych technik',
  'onboarding.valueFree': 'Darmowe na zawsze · Bez reklam · Bez sztuczek',
