export default {
  ...
  // Calendar
  'calendar.sessions_one': '{{count}} cvičenie',
  ...
  'onboarding.noCardRequired': 'Kreditná karta nie je potrebná',
  'onboarding.socialProof1': 'Oblúbené medzi športovcami',
  'onboarding.socialProof2': 'Stanford-backed',
  'onboarding.socialProof3': 'Apple Health',
  'onboarding.commitTitle': 'Nastavte si denný cieľ',
  'onboarding.commitSub': 'Malé každodenné návyky vytvárajú trvalú zmenu.',
  'onboarding.commitMinUnit': 'min / deň',
  'onboarding.commitHint_3': 'Dokonca aj 3-minútové cvičenie môže pomôcť upokojiť nervový systém.',
  'onboarding.commitHint_5': 'Výskum Stanfordu spája pomalé dýchanie s nižším stresom a lepším spánkom.',
  'onboarding.commitHint_10': 'Navy SEALs používa Box Breathing na udržanie sústredenosti pod tlakom.',
  'onboarding.commitHint_15': 'Dr. Andrew Huberman odporúča 15 min denného dychového cvičenia pre trvalé výsledky.',
  'onboarding.buildingTitle': 'Zostavujeme váš plán...',
  'onboarding.buildingStep1': 'Analyzovanie vášho cieľa',
  'onboarding.buildingStep2': 'Výber techník',
  'onboarding.buildingStep3': 'Personalizácia vášho harmonogramu',
  'onboarding.valueProgress': 'Sledujte denný pokrok a série',
  'onboarding.valueBadges': 'Získajte odznaky za míľniky',
  'onboarding.valueHealth': 'Synchronizácia s Apple Health',
  'onboarding.valueTechniques': '10 vedecky podložených techník',
  'onboarding.valueFree': 'Zadarmo navždy · Bez reklám · Bez trikov',
  ...
  'paywall.feature1': 'Všetkých 10 dýchacích techník',
  'paywall.feature2': 'Všetky hudobné stopy',
  'paywall.feature3': 'Odomknúť všetky odznaky',
  'paywall.feature4': 'Úplná história a štatistiky',
  ...
  'paywall.perYear': 'ročne',
  'paywall.unlockForever': 'Odomknúť navždy',
  'paywall.startAnnual': 'Začať ročný plán',
  'paywall.startWeekly': 'Začať týždenný',
