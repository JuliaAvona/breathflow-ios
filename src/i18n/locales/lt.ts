export default {
  ...
  'home.justBreathe': 'Tiesiog kvėpuok',
  'home.min': 'min',
  ...
  'calendar.sessions_other': '{{count}} sesijų',
  ...
  'onboarding.noCardRequired': 'Kreditinės kortelės nereikia',
  'onboarding.socialProof1': 'Sportininkų patikimas',
  'onboarding.socialProof2': 'Stanford-backed',
  'onboarding.socialProof3': 'Apple Health',
  'onboarding.commitTitle': 'Nustatykite savo kasdienį tikslą',
  'onboarding.commitSub': 'Mažos kasdienės įpročių lemia ilgalaikius pokyčius.',
  'onboarding.commitMinUnit': 'min / dieną',
  'onboarding.commitHint_3': 'Net 3 minučių sesija gali padėti nuraminti nervų sistemą.',
  'onboarding.commitHint_5': 'Stanfordo tyrimai sieja lėtą kvėpavimą su mažesniu stresu ir geresniu miegu.',
  'onboarding.commitHint_10': 'Navy SEALs naudoja Box Breathing, kad išliktų susikaupę esant spaudimui.',
  'onboarding.commitHint_15': 'Dr. Andrew Huberman rekomenduoja 15 min kasdienio kvėpavimo praktikos.',
  'onboarding.buildingTitle': 'Kuriame jūsų planą...',
  'onboarding.buildingStep1': 'Analizuojamas jūsų tikslas',
  'onboarding.buildingStep2': 'Parenkamos technikos',
  'onboarding.buildingStep3': 'Personalizuojamas jūsų grafikas',
  'onboarding.valueProgress': 'Stebėkite kasdienę pažangą ir serijas',
  'onboarding.valueBadges': 'Uždirbkite ženklelius už pasiekimus',
  'onboarding.valueHealth': 'Sinchronizacija su Apple Health',
  'onboarding.valueTechniques': '10 mokslo pagrįstų technikų',
  'onboarding.valueFree': 'Visada nemokama · Be reklamos · Be gudrybių',
  ...
  'paywall.feature1': 'Visos 10 kvėpavimo technikų',
  'paywall.feature2': 'Visi muzikos įrašai',
  'paywall.feature3': 'Atrakinti visus ženklelius',
  ...
  'paywall.unlockForever': 'Atrakinti amžinai',
  'paywall.startAnnual': 'Pradėti metinį planą',
  'paywall.startWeekly': 'Pradėti savaitinį',
