export default {
  ...
  'onboarding.noCardRequired': 'Geen creditcard vereist',
  'onboarding.socialProof1': 'Vertrouwd door atleten',
  'onboarding.socialProof2': 'Stanford-backed',
  'onboarding.socialProof3': 'Apple Health',
  'onboarding.commitTitle': 'Stel je dagelijkse doel in',
  'onboarding.commitSub': 'Kleine dagelijkse gewoonten creëren blijvende verandering.',
  'onboarding.commitMinUnit': 'min / dag',
  'onboarding.commitHint_3': 'Zelfs een sessie van 3 minuten kan je zenuwstelsel helpen kalmeren.',
  'onboarding.commitHint_5': 'Stanford-onderzoek verbindt langzaam ademen met minder stress en beter slapen.',
  'onboarding.commitHint_10': 'Navy SEALs gebruiken Box Breathing om gefocust te blijven onder druk.',
  'onboarding.commitHint_15': 'Dr. Andrew Huberman raadt 15 min dagelijks ademwerk aan voor blijvende resultaten.',
  'onboarding.buildingTitle': 'Je plan wordt opgesteld...',
  ...
  'onboarding.valueProgress': 'Volg dagelijkse voortgang en reeksen',
  ...
  'onboarding.valueFree': 'Voor altijd gratis · Geen advertenties · Geen trucjes',
  ...
  'paywall.feature3': 'Ontgrendel alle badges',
  ...
  'paywall.weeklyNote': '{{price}}/week, automatisch verlengd. Annuleer op elk moment in App Store-instellingen.',
  'paywall.annual': '1 Jaar',
  'paywall.perYear': 'per jaar',
  'paywall.unlockForever': 'Ontgrendel voor altijd',
