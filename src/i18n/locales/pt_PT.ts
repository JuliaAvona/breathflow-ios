export default {
  ...
  'onboarding.noCardRequired': 'Não é necessário cartão de crédito',
  'onboarding.socialProof1': 'De confiança para atletas',
  'onboarding.socialProof2': 'Stanford-backed',
  'onboarding.socialProof3': 'Apple Health',
  'onboarding.commitTitle': 'Define o teu objetivo diário',
  'onboarding.commitSub': 'Os pequenos hábitos diários criam uma mudança duradoura.',
  'onboarding.commitMinUnit': 'min / dia',
  'onboarding.commitHint_3': 'Até uma sessão de 3 minutos pode ajudar a acalmar o sistema nervoso.',
  'onboarding.commitHint_5': 'A investigação de Stanford liga a respiração lenta a menos stress e melhor sono.',
  'onboarding.commitHint_10': 'Os Navy SEALs usam a Respiração em Caixa para se manterem focados sob pressão.',
  ...
  'onboarding.buildingStep2': 'A selecionar técnicas',
  'onboarding.buildingStep3': 'A personalizar o teu horário',
  'onboarding.valueProgress': 'Acompanha o progresso diário e sequências',
  'onboarding.valueBadges': 'Ganha emblemas por marcos',
  'onboarding.valueHealth': 'Sincroniza com Apple Health',
  'onboarding.valueTechniques': '10 técnicas suportadas pela ciência',
  ...
  'paywall.bestValue': 'Melhor relação qualidade/preço',
  'paywall.weeklyNote': '{{price}}/semana, renovação automática. Cancele a qualquer momento nas definições da App Store.',
