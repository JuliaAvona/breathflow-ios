export default {
  ...
  'home.justBreathe': 'Vienkārši elpo',
  'home.min': 'min',
  ...
  'onboarding.noCardRequired': 'Kredītkarte nav nepieciešama',
  'onboarding.socialProof1': 'Sportistu uzticēts',
  'onboarding.socialProof2': 'Stanford-backed',
  'onboarding.socialProof3': 'Apple Health',
  'onboarding.commitTitle': 'Uzstādiet savu dienas mērķi',
  'onboarding.commitSub': 'Mazas ikdienas ieradumi rada paliekošas pārmaiņas.',
  'onboarding.commitMinUnit': 'min / dienā',
  'onboarding.commitHint_3': 'Pat 3 minūšu sesija var palīdzēt nomierināt nervu sistēmu.',
  'onboarding.commitHint_5': 'Stenfordas pētījumi saista lēnu elpošanu ar mazāku stresu un labāku miegu.',
  'onboarding.commitHint_10': 'Navy SEALs izmanto Box Breathing, lai saglabātu fokusu zem spiediena.',
  'onboarding.commitHint_15': 'Dr. Andrew Huberman iesaka 15 min ikdienas elpošanas prakses.',
  'onboarding.buildingTitle': 'Veidojam jūsu plānu...',
  'onboarding.buildingStep1': 'Analizējam jūsu mērķi',
  'onboarding.buildingStep2': 'Izvēlamies tehnikas',
  'onboarding.buildingStep3': 'Personalizējam jūsu grafiku',
  'onboarding.valueProgress': 'Izsekojiet ikdienas progresu un sērijas',
  'onboarding.valueBadges': 'Nopelniet žetonus par sasniegumiem',
  'onboarding.valueHealth': 'Sinhronizācija ar Apple Health',
  'onboarding.valueTechniques': '10 zinātniski pamatotas tehnikas',
  'onboarding.valueFree': 'Bezmaksas uz visiem laikiem · Bez reklāmām · Bez trikiem',
  ...
  'paywall.feature1': 'Visas 10 elpošanas tehnikas',
  'paywall.feature2': 'Visi mūzikas ieraksti',
  'paywall.feature3': 'Atbloķēt visas nozīmītes',
  'paywall.feature4': 'Pilna vēsture un statistika',
  ...
  'paywall.perYear': 'gadā',
  'paywall.unlockForever': 'Atbloķēt uz visiem laikiem',
  'paywall.startAnnual': 'Sākt gada plānu',
  'paywall.startWeekly': 'Sākt nedēļas',
