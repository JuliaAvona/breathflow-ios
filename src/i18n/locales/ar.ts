export default {
  ...
  // Calendar
  'calendar.sessions_one': '{{count}} جلسة',
  'calendar.sessions_other': '{{count}} جلسات',
  ...
  'onboarding.noCardRequired': 'لا بطاقة ائتمانية مطلوبة',
  ...
  'onboarding.commitHint_10': 'يستخدم أفراد Navy SEALs التنفس الصندوقي للتركيز تحت الضغط.',
  'onboarding.commitHint_15': 'يوصي د. أندرو هوبرمان بـ 15 دقيقة يومياً من تمارين التنفس.',
  'onboarding.buildingTitle': 'جاري بناء خطتك...',
  'onboarding.buildingStep1': 'تحليل هدفك',
  'onboarding.buildingStep2': 'اختيار التقنيات',
  'onboarding.buildingStep3': 'تخصيص جدولك',
  'onboarding.valueProgress': 'تتبع التقدم اليومي والسلاسل',
  'onboarding.valueBadges': 'اكسب شارات للإنجازات',
  'onboarding.valueHealth': 'مزامنة مع Apple Health',
  'onboarding.valueTechniques': '10 تقنيات مدعومة علمياً',
  'onboarding.valueFree': 'مجاني للأبد · بلا إعلانات · بلا خدع',
  ...
  // Notifications
  'notifications.streakProtectionTitle': 'حماية السلسلة',
  'notifications.streakProtectionBody': 'لديك سلسلة {{streak}} يومًا! لا تنسَ التنفس اليوم.',
  'notifications.weeklySummaryTitle': 'الملخص الأسبوعي',
  'notifications.weeklySummaryBody': '{{sessions}} جلسات، {{minutes}} دقيقة هذا الأسبوع. استمر!',
  'notifications.badgeUnlocked': 'تم فتح الشارة!',
  'notifications.reminderTitle': 'حان وقت التنفس',
  'notifications.reminderBody': 'خصّص لحظة لممارسة تمارين التنفس.',
  'notifications.sessionCompleteTitle': 'اكتملت الجلسة',
  'notifications.sessionCompleteBody': 'جلسة {{technique}} رائعة! عقلك وجسدك يشكرانك.',
  'notifications.tip1': 'يمكن للتنفس الصندوقي خفض الكورتيزول في أربع دقائق فقط.',
  'notifications.tip2': 'جلسة تنفس مدتها خمس دقائق تحسّن التركيز لساعات.',
  'notifications.tip3': 'التنفس العميق ينشّط الجهاز العصبي السمبتاوي.',
  'notifications.tip4': 'جرّب التنفس الفسيولوجي للتخلص الفوري من التوتر.',
  'notifications.tip5': 'التنفس بمعدل 5.5 نفَس في الدقيقة يُحسّن تباين معدل ضربات القلب.',
  'notifications.tip6': 'حتى دقيقة واحدة من التنفس الواعي تُحدث فارقًا.',
  'notifications.tip7': 'الزفير الممتد يُخبر جسمك أنه آمن للاسترخاء.',
  ...
  'paywall.annual': 'سنة واحدة',
  'paywall.perYear': 'في السنة',
  ...
  'paywall.annualBilled': 'يُحاسب سنوياً',
  'paywall.annualTrial': 'تجربة مجانية لمدة 7 أيام',
  'paywall.lifetimeBilled': 'يُحاسب',
